...
struct Config
{
    ...
    inline const static double speciationThreshold = 1.77;
    inline const static double mutateBiasShiftProbability = 0.8;
    inline const static double initialLinkProbability = 0.70;
